...
<body>
    ...
    <header id="home">
        ...
        <nav class="mode-bg">
            ...
            <ul>
                <li><a class="mode-text" href="../index.html">Home</a></li>
            ...
            <div class="games-table">
                ...
                <table class="table games">
                    ...
                    <?php 
                        ...
                        <?php } ?>
                        <td>
                            <a class="edit-icon" href="aksi/game_edit.php?id=<?php echo $row['id']; ?>">
                                <i class="fa-solid fa-pen-to-square"></i> Update
                            </a>
                            <a class="del-icon" href="aksi/game_delete.php?id=<?php echo $row['id']; ?>">
